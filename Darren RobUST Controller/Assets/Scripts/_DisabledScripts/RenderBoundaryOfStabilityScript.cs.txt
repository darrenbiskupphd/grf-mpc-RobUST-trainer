...
public class RenderBoundaryOfStabilityScript : MonoBehaviour
{
    // Whether or not we need the boundary of stability
    public bool useBoundaryOfStability;
    ...
    void Start()
    {
        if(useBoundaryOfStability == true)
        {
