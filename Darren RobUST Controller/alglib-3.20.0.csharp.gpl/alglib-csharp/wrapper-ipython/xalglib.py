...
if curdir=="":
    curdir = "."
_net_candidates = []
_net_candidates.append(os.path.join(os.path.relpath(curdir),"alglib320gpl_net2.dll"))
_net_candidates.append(os.path.join(sys.prefix,"alglib320gpl_net2.dll"))
_net_candidates.append(os.path.join(os.sep+"usr","local","alglib320gpl_net2.dll"))
