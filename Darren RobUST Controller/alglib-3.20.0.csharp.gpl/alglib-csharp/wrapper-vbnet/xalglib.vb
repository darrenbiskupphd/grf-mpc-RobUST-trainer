...
End Sub
    ...
    Public Sub rbfsetv3tol(ByVal s As rbfmodel, ByVal tol As Double)
        Try
    ...
    Public Sub rbfsetfastevaltol(ByVal s As rbfmodel, ByVal tol As Double)
        Try
    ...
    Public Sub rbffastcalc(ByVal s As rbfmodel, ByVal x() As Double, ByRef y() As Double)
        Try
